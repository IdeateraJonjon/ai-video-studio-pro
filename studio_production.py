"""
Professional AI Video Studio - Production Launch
Runs on port 80 (no :5000 needed)
"""
...
if __name__ == '__main__':
    ...
    print()
    print("IMPORTANT: Run setup_domain.bat as Administrator first!")
    print()
    print("Starting on multiple domains:")
    print("  http://localhost")
    print("  http://visual-video-studio.local")
    print("  http://ai-video-studio.local") 
    print("  http://studio.local")
    print()
    print("No port number needed! (Running on port 80)")
    ...
    # Run on port 80 (requires Administrator on Windows)
    try:
        app.run(debug=False, host='0.0.0.0', port=80)
    except PermissionError:
        print()
        print("ERROR: Port 80 requires Administrator privileges!")
        print("Alternative: Running on port 8080...")
        print("Access at: http://visual-video-studio.local:8080")
